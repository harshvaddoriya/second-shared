                        ...
                        <div className={styles.mainIllustration}>
                            <svg viewBox="0 0 400 300" className={styles.errorSvg}>
                                ...
                                <g transform="translate(175, 120)">
                                    ...
                                    <path d="M25 18 a4 4 0 1 1 -0.01 0z M20 26 h8 v20 h-10z" fill="#e18ece" opacity="0.9" />
                                </g>
                                ...
                                <text x="80" y="60" className={styles.floatingNumber} fill="#4267B2" opacity="0.6">4</text>
                                <text x="320" y="80" className={styles.floatingNumber} fill="#4267B2" opacity="0.6">0</text>
                                <text x="300" y="200" className={styles.floatingNumber} fill="#4267B2" opacity="0.6">4</text>
                            </svg>
                        </div>
                    ...
                    <div className={styles.contentSection}>
                        <div className={styles.errorContent}>
                            ...
                            <p className={styles.errorDescription}>
                                ...
                                This sometimes happens when the privacy settings have changed.
                            </p>
