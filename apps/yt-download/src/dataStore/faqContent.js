...
export const shortsFaq = [
    {
        question: "Is it possible to download Youtube Shorts to my PC?",
        answer:
    ...
    },
    {
        ...
        answer: `It's safe! You can download Youtube Shorts with YoutubeDl without any worries. Our safety policy ensures we don't collect any of your personal data through this tool. We really value your trust in us!`
    },
];
export const shortsSteps = [
    {
        image: Images.step1,
        title: "Copy the URL",
        text: "Open Youtube site or app. Open the page with Shorts and copy the URL of the page.",
        link: "/shorts"
    },
    {
        image: Images.step2,
        title: "Paste the link",
        text: `Paste the link from the Youtube Shorts downloader page into the input line. Make sure the YoutubeDl website is already open.`,
        link: "/shorts"
    },
    {
        image: Images.step3,
        title: "Download",
        text: `Click the Download button to save the Shorts to your device.`,
        link: "/shorts"
    },
];
...
export const mainFaq = [
    ...
    },
    {
        ...
        answer: `Dear content creators, please know that YoutubeDl.app does not store any files or share any links on its servers. All your content is saved on Youtube’s official website. If you feel your work has been used without permission, please contact Youtube’s support at Youtube.com.`,
    },
    {
